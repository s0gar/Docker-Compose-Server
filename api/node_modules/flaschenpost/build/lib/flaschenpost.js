...
const defaultOutput_1 = require("./defaultOutput");
...
class Flaschenpost {
    constructor() {
        ...
        this.configuration = new Configuration_1.Configuration(debugModuleFilter, formatter, defaultOutput_1.defaultOutput, highestEnabledLogLevel, hostname, logEntryIdGenerator);
    }
